...
namespace Lab03
{
    public class Lab03 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            /*if (currMouseState.MiddleButton == ButtonState.Pressed &&
                prevMouseState.MiddleButton == ButtonState.Pressed)
            {
                translate -= (currMouseState.X - prevMouseState.X) / 10f;
                translate2 -= (currMouseState.Y - prevMouseState.Y) / 10f;
            }*/
            ...
            {
                //distance  -= (cameraPos.Z - cameraPos.Z) / 100.0f;
                cameraPos.Z += (currMouseState.Y - prevMouseState.Y) / 100.0f;
            }*/


            //if (Mouse.GetState().MiddleButton == ButtonState.Pressed && prevMouseState.MiddleButton == ButtonState.Pressed)
            //{
            //    cameraPos.X += (currMouseState.X - prevMouseState.X) * translate;
            //    cameraPos.Y -= (currMouseState.Y - prevMouseState.Y) * translate; // Notice the minus sign for Y-axis
            //}


            //if (Mouse.GetState().MiddleButton == ButtonState.Pressed && prevMouseState.MiddleButton == ButtonState.Pressed)
            //{
             //   cameraPos.X += (currMouseState.X - prevMouseState.X) / 100.0f;
            //    cameraPos.Y += (currMouseState.Y - prevMouseState.Y) / 100.0f;
            //}
